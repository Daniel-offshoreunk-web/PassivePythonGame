...
Gambling""",\
    ...
    def ondraw(self, event):
        if self.cooldown() == True:
            ...
            self.rarity("black", "Unknown I", 700, 98,'self.canvas.itemconfigure(self.result_text, fill="white")')
            self.rarity("black", "Unknown II", 4000, 99.5, 'self.canvas.itemconfigure(self.result_text, fill="white")')
            self.rarity("black", "Unknown III", 45000, 99.75, 'self.canvas.itemconfigure(self.result_text, fill="white")')
